    ...
    <StyledStepFour>
      ...
      <div className="step_four-info-contents-container">
        <div className="step_four-info-one-content-container">
          <span>{activeLanguage === "English" ? infoOne?.paragraphOneEng : infoOne?.paragraphOneHr}</span>
          <span> {activeLanguage === "English" ? infoOne?.paragraphTwoEng : infoOne?.paragraphTwoHr} </span>
          <span> <Link
            to={"/"}>{activeLanguage === "English" ? infoOne?.paragraphThreeEng : infoOne?.paragraphThreeHr}</Link> </span>
          <span>{activeLanguage === "English" ? infoOne?.paragraphFourEng : infoOne?.paragraphFourHr}</span>
        </div>
        <div className="step_four-info-two-content-container">
          <span>{activeLanguage === "English" ? infoTwo?.paragraphOneEng : infoTwo?.paragraphOneHr}</span>
        </div>
      </div>
    </StyledStepFour>
  )
