...
export const StyledLanguage = styled.div`
  ...
  .language_wrapper {
    ...
    .language_title-content-container {
      width: 100%;
      height: fit-content;
      display: flex;
      ...
      .language_custom-select-container {
        width: 50%;
        height: 50px;
        position: relative;

        .language_custom-select-active {
          width: 100%;
          height: 100%;
          ...
          .language_custom-select-selected-language {
            width: 75px;
            display: flex;
            justify-content: center;
            align-items: center;
          ...
          .language_custom-select-active-svg-container {
            width: fit-content;
            height: 100%;
            display: flex;
            justify-content: center;
        ...
        .language_custom-select-dropdown {
          position: absolute;
          width: 100%;
          height: fit-content;
          background-color: rgb(0, 0, 0);
          ...
          .language_custom-select-dropdown-title-container {
            width: 100%;
            display: flex;
            justify-content: center;
            align-items: center;
    ...
    .language-button-container {
      ...
      transform: ${props => props?.languageDropdownActive ? "translateY(50px)" : "translateY(0)"};
