...
export const StyledPassword = styled.div`
  ...
  .account_password-form-wrapper {
    ...
    .account_password-form-inputs-container {
      display: flex;
      justify-content: center;
      align-items: center;
      width: 100%;
      ...
      .account_password-form-single-input-container {
        width: 100%;
        height: fit-content;
        position: relative;
    ...
    .account_password-form-buttons-container {
      width: 100%;
      display: flex;
      justify-content: center;
      align-items: center;
