...
export const StyledEmail = styled.div`
  ...
  .account_email-form-wrapper {
    ...
    .account_email-form-inputs-container {
      display: flex;
      justify-content: center;
      align-items: center;
      width: 100%;
      ...
      .account_email-form-single-input-container {
        width: 100%;
        height: fit-content;
        position: relative;
      ...
      .account_email-form-buttons-container {
        width: 100%;
        display: flex;
        justify-content: center;
        align-items: center;
